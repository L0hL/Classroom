...
public class CaveRoomPd8 {
	...
	public static final int NORTH = 0; //final = constant ; mean it won't change... North will always be 0
	public static final int EAST = 1; // constants are usually capitalized
	public static final int SOUTH = 2; // if more than one word u do _ ex: NORTH_DIRECTION
	...
	public CaveRoomPd8(String description){
		...
		for(int i = 0 ; i < borderingRooms.length; i++){
			...
			doors[i] = null; */
		// not needed ^ b/c new object types are set to null
		//}
		setDirections();
	}
