...
public abstract class Screen {
	...
	public void remove(Visible v){
		/**ArrayList notes
		 * while this method is very simple, do not underestimate the trickiness
		 * of removing items in an ArrayList. It causes indices to change:
		 * Example suppose you have an AnrrayList<Integer> 
